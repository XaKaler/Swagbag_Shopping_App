...
class OrderModel : ArrayList<OrderModel.OrderModelItem>(){
    data class OrderModelItem(
        ...
        val createdDate: String, // 2022-02-12T06:12:49.247Z
        val deleted: Int, // 0
        val finalprice: String, // 464
        val gateway: String, // COD
        @SerializedName("gift_card")
        val giftCard: String, // 61e57eca0ee4253f3804c31f
        ...
        @SerializedName("_id")
        val id: String, // 62074fe1bad1ac2490cc2d95
        val note: String,
        val orderid: String, // SB-1644646369
        val otp: String,
        val packing: String, // 40
        val paid: Int, // 0
        ...
        val shipping: String, // 14
        val status: String, // processing
        val transactionid: String,
        val type: String, // Normal
        @SerializedName("update_date")
        val updateDate: String, // 2022-02-12T06:12:49.247Z
        ...
        data class Address(
            ...
            val contactMobile: String, // 1234567890
            @SerializedName("contact_name")
            val contactName: String, // pooja karthik
            val country: String,
            @SerializedName("created_date")
            val createdDate: String, // 2022-03-03T08:11:30.411Z
            val deleted: Int, // 0
            @SerializedName("_id")
            val id: String, // 6220852549ad231a4e66f06e
            val pincode: String, // 632005
            val position: Position,
            @SerializedName("post_office")
            val postOffice: String,
            val state: String, // dubai
            val title: String, // Other
            @SerializedName("update_date")
            val updateDate: String, // 2022-03-03T08:11:30.411Z
            val user: String, // 6220852449ad231a4e66f06c
            @SerializedName("__v")
            val v: Int // 0
        ) {
            data class Position(
        ...
        data class Product(
            val `final`: String, // 450
            @SerializedName("_id")
            val id: String, // 62074fe1bad1ac2490cc2d96
            val option: List<Option>,
            val price: Int, // 440
            val product: Product,
            val productname: String, // Beige Pink Floral Mini Wrap Dress
            val quantity: Int // 1
        ) {
            data class Option(
