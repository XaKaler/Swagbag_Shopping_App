...
import com.shopping.swagbag.databinding.SingleWithImageCollase2Binding
...
class CollageAdapter2(
    private val context: Context,
    private val data: List<DummyModel>
) :
    RecyclerView.Adapter<CollageAdapter2.CollageViewHolder>() {

    inner class CollageViewHolder(private val viewBinding: SingleWithImageCollase2Binding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CollageViewHolder{
        return CollageViewHolder(
            SingleWithImageCollase2Binding.inflate(
